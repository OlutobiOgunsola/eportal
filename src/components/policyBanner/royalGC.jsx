...
export default function RoyalGroupCareBanner ({}) {
    ...
    return <Grid columns={2} stackable className="splash_container"
      ...
      >
        <div id="policy_title">
          ...
          <RevealChildren data-aos="slide-down" data-aos-duration="3000">
            <h3 className='header-text'>Group Care</h3>
          </RevealChildren>
        </div>
