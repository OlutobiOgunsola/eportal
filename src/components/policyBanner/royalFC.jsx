...
export default function RoyalFamilyCareBanner ({}) {
    ...
    return <Grid columns={2} stackable className="splash_container"
      ...
      >
        <div id="policy_title">
          ...
          <RevealChildren data-aos="slide-down" data-aos-duration="3000">
            <h3 className='header-text'>Family Care</h3>
          </RevealChildren>
        </div>
