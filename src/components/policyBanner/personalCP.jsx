...
export default function PersonalCareBanner({}) {
  ...
  return (
    <BannerWrapper className="personal_cp">
      <Grid
        columns={2}
        stackable
        ...
        >
          ...
          <div id="policy_copy">
            ...
            <RevealChildren
              ...
              data-aos-duration="3000"
            >
              <p>{PolicyCopies.personalCP.summary}</p>
            </RevealChildren>
          </div>
        </Grid.Column>
      </Grid>
