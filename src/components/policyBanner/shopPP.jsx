...
export default function ShopProtectionBanner({}) {
  ...
  return (
    <BannerWrapper className="shop_pp">
      <Grid
        columns={2}
        stackable
        ...
        >
          ...
          <div id="policy_copy">
            ...
            <RevealChildren
              ...
              data-aos-duration="3000"
            >
              <p>{PolicyCopies.shopPP.summary}</p>
            </RevealChildren>
          </div>
        </Grid.Column>
      </Grid>
