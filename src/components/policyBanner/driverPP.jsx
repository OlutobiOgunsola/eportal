...
import { GoTo, createExploreUrl, openExplore } from "../../lib/helpers";

export default function DriverProtectionBanner({}) {
    ...
    >
      ...
      >
        <div id="policy_title">
          ...
          <RevealChildren data-aos="slide-down" data-aos-duration="3000">
            <h2 className="header-text">Group Care</h2>
          </RevealChildren>
        </div>
      ...
      <Grid.Column
        ...
        id="right_column"
      >
        <div id="policy_img" data-aos="slide-up" data-aos-duration="1500">
          <img
        ...
        <div id="policy_copy">
          ...
          >
            <p>{PolicyCopies.driverPP.summary}</p>
          </RevealChildren>
        </div>
      </Grid.Column>
    </Grid>
